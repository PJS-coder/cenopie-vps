            ...
            <div className="lg:col-span-3 order-1 lg:order-2">
                ...
                {error ? (
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      There are no news articles to display at the moment. Check back later for updates!
                    </p>
                  </div>
                ) : (
                  news.map((article) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2">
                              <h4 className="font-semibold text-gray-900">{article.company.name}</h4>
                              <VerificationBadge isVerified={article.company.isVerified} size="sm" />
                            </div>
                        ...
                        {/* Article Content */}
                        <div>
                          <h2 className="text-xl font-bold text-gray-900 mb-3 hover:text-[#0BC0DF] transition-colors">{article.title}</h2>
              ...
              {news.length > 0 && (
                <div className="mt-8 text-center">
                  <button
                    onClick={refreshNews}
                    className="bg-white hover:bg-gray-50 text-gray-700 px-6 py-2 rounded-lg border border-gray-200 transition-colors"
                  >
                    Refresh News
                  </button>
                </div>
