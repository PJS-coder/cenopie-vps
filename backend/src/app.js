...
import showcaseBannerRoutes from './routes/showcaseBannerRoutes.js';
import bannerRoutes from './routes/bannerRoutes.js';
import adminBannerRoutes from './routes/adminBannerRoutes.js';
import adminShowcaseBannerRoutes from './routes/adminShowcaseBannerRoutes.js';
...
app.use('/api/showcase-banners', showcaseBannerRoutes);
app.use('/api/banners', bannerRoutes);
app.use('/api/admin/banners', adminBannerRoutes);
app.use('/api/admin/showcase-banners', adminShowcaseBannerRoutes);
